...
SECRET_KEY = 'j&195986*luc$w%u6#4k9p^-w!hzfnyw*21n87*18#!@sulr6u'
...
REST_FRAMEWORK = {
    ...
    # to override the ratelimit framework exception
...
# Google Django s3, it will provide the S3 settings
...
AWS_STORAGE_BUCKET_NAME = 'django-twitter-wendy'
...
AWS_ACCESS_KEY_ID = 'AKIAX2GO36VDJQWF2EXX'
AWS_SECRET_ACCESS_KEY = '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'


# media 的作用适用于存放被用户上传的文件信息AKIAX2GO36VDJQWF2EXX
